...
class Place(models.Model):
	...
	long_description = HTMLField(
		verbose_name="Полное описание", blank=True, null=False
	)
	longitude = models.DecimalField(
		verbose_name="Долгота", max_digits=17, decimal_places=14
	)
	latitude = models.DecimalField(
		verbose_name="Широта", max_digits=17, decimal_places=14
	)
